...
class UserRegisterform(UserCreationForm):
    ...
    def clean_username(self):
        ...
        user = self.cleaned_data.get('username').capitalize()
    ...
    def clean_email(self):   
        ...
        if email.endswith('@outlook.com') or email.endswith('@gmail.com') or email.endswith('@hotmail.com') or email.endswith('@yahoo.com') or email.endswith('@icloud.com'):
            return email
        else:
